...
<div class="text-left flex flex-col w-full max-w-[698px] px-6 py-0 md:py-10">
	...
	<p class="typo-b4 text-left mt-10">
		...
		>ให้สามารถนำข้อมูลมาเปรียบเทียบกันได้เสียก่อน
		<br />
		<br />
	...
	<h7 class="typo-h7">
		<b>
			1. ถ้า<span class="beyonx-text-gradient">พรรคเพื่อไทย</span>ส่งผู้สมัคร
			ครบทุกเขตเมื่อปี 62?
		</b>
	</h7>
	<span
	...
	{#if isInfor1Open}
		<h4 class="typo-b4 mt-4">
			...
			<br />
			<br />
			เพื่อสร้างแบบจำลองผลเลือกตั้ง 66 ที่แม่นยำขึ้น เราจึงต้องประมาณการผลเลือกตั้ง
			62 โดย<b>สมมติว่าพรรคเพื่อไทยส่งผู้สมัครครบทุกเขตเลือกตั้ง</b> โดยใช้วิธี ประมาณคะแนนของพรรคเพื่อไทยในเขตที่ไม่ได้ลงสมัครจากเขตเลือกตั้งรอบข้างที่มีพรรคเพื่อไทยลงสมัครรับเลือกตั้ง
		</h4>
	{/if}
	...
	<h7 class="typo-h7">
		<b>
			2. จาก <span class="beyonx-text-gradient">จัดสรรปันส่วนผสม</span> กลับสู่
			เลือกคนที่รัก
	...
	{#if isInfor2Open}
		<h4 class="typo-b4 my-4">
			การเลือกตั้ง 66 มีการเปลี่ยนแปลงกติกาหลักๆ จากปี 62 คือ
			<br />
			<br />
			<ul>
				<li>
			...
			<br />
			<br /> ในการปรับฐานนี้ เราจะเรานำกติกาของการเลือกตั้งปี 66
