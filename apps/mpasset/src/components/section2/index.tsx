  ...
  return (
    <div className='h-full flex flex-col items-center justify-center gap-y-[20px]'>
      <div className='typo-ibmplex typo-b4 leading-[150%] text-center px-[20px] max-w-[640px]'>
        ...
        ไม่ใช้อำนาจจากการดำรงตำแหน่งทางการเมือง<br className='hidden tablet:block' />ที่เอื้อผลประโยชน์ต่อบริษัทตนเองหรือผู้อื่น<br className='hidden tablet:block' />พวกเราเลยอยากชวนทุกคนสำรวจข้อมูลนักการเมือง ทั้งผู้สมัคร ส.ส. , ส.ส. และ ครม.<br className='tablet:hidden' />
