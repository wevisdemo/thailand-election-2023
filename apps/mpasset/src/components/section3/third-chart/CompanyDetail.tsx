...
const CompanyDetail = ({ open, onToggle }: Props) => {
  ...
  return (
    <div className={`absolute w-full
      ...
      max-w-[480px]
      `}>
      <div className='flex flex-row justify-between items-center mb-[10.5px] cursor-pointer desktop:cursor-default' onClick={() => onToggle()}>
            ...
            typo-b7'>
              ...
              <div className='inline-flex gap-x-[5px]'>
                <div className='relative'>
                  <svg className='w-[21px] h-[20px]' viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className='absolute text-[10px] inset-x-0 text-center  font-bold inset-0 top-[4px] '>{relatedCompanyToGovernmentCount.countPolShareholder}</div>
                </div>
