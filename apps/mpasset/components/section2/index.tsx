  ...
  return (
    <div className='h-full flex flex-col items-center justify-center gap-y-[20px]'>
      <div className='typo-ibmplex typo-b4 leading-[150%] text-center px-[20px]'>
        ความเกี่ยวข้องกับธุรกิจผ่านการถือหุ้นของนักการเมือง ไม่ใช่เรื่องที่ทำไม่ได แต่เพื่อเกิดความโปร่งใส<br />
        ไม่ใช้อำนาจจากการดำรงตำแหน่งทางการเมืองที่เอื้อผลประโยชน์ต่อบริษัทตนเองหรือผู้อื่นพวกเราเลยอยากชวนทุกคนสำรวจข้อมูล ส.ส. และ ครม.<br />
