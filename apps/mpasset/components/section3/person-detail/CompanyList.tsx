              ...
              w-fit overflow-y-scroll'>
                {companyData.map((data) => (
                  <div key={`comp-${data.company_name_en}`}
                    ...
                    <div className='typo-b5 typo-ibmplex leading-[150%]'>{`บริษัท ${data.company_name_th}`}</div>
                    <div className='flex-grow flex flex-row gap-x-[12px] items-center flex-nowrap justify-end text-end'>
